...
const mStyles = StyleSheet.create({
  ...
  container: { backgroundColor: '#0F1F40', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, gap: 14, borderWidth: 1, borderBottomWidth: 0, borderColor: 'rgba(255,255,255,0.1)' },
